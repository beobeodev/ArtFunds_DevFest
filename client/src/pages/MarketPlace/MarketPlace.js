      ...
      <div className='market_filter-left'>
        <div className='market_filter-content'>
          <ul className='market_status has-child'>
            ...
            <li>
              <div className='market_checkbox'>
                <input type='checkbox' name='onsale' id='onsale' value='onsale' className='market_input_check' />
              ...
              <div className='market_checkbox'>
                <input type='checkbox' name='auction' id='auction' value='auction' />
          ...
          <ul className='market_price has-child'>
            <h2>Theo giá bán</h2>
            <li>
              <input type='text' name='minprice' id='minprice' placeholder='Thấp nhất' />
              <input type='text' name='maxprice' id='maxprice' placeholder='Cao nhất' />
            </li>
          </ul>
        </div>
      </div>
